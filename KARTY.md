...
|---|---|---|
| Mediterranean Avenue | **Szopa na Jasnej** | wchodzisz na własne ryzyko |
...
| Oryginał | GORIpoly | Podpis |
|---|---|---|
| New York Avenue | **Mieszkanie na Porcie Popowice** | pierwsza inwestycja zostaje w sercu na zawsze |
...
- Wygląd do druku: `karty.html` (+ `karty.css`). Milimetry, keyline 3,5 mm od cięcia, spad 3 mm, symbol waluty jako SVG, wachlarz ikonek, arkusz A4 po 9 kart ze znacznikami cięcia. Przycisk "1 karta / stronę" przełącza na format 62 x 93 mm - to wersja dla drukarni.
...
- **Netto** 56 x 87 mm, **spad** 3 mm z każdej strony (element 62 x 93 mm), **strefa bezpieczna** 3,5 mm od cięcia - siedzi w niej czarny keyline, więc jak drukarnia utnie z tolerancją 1 mm, nic ważnego nie zniknie.
- Wszystkie karty poza rewersem mają biały spad (tło karty jest białe, treść zamknięta w keylinie), więc przesunięcie cięcia nie zrobi kolorowego paska na krawędzi. Pełny spad ma tylko rewers.
- **Arkusz A4**: 9 kart, odstęp 2 mm, w odstępie czarne znaczniki cięcia (hairline 0,1 mm) na przedłużeniu linii cięcia. Marginesy strony 3 mm.
- **Do drukarni** lepszy jest tryb "1 karta / stronę": PDF w formacie 62 x 93 mm, jedna karta na stronę, bez znaczników. Impozycję i cięcie robią u siebie, na swoim arkuszu i swojej maszynie.
- Do zamówienia dopisać: format netto 56 x 87 mm, spad 3 mm, CMYK, 300 DPI, karton 300 g + folia, zaokrąglenie rogów 3 mm.
